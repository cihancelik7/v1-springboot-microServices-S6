package com.cihancelik.loans.controller;

import com.cihancelik.loans.constants.LoansConstants;
import com.cihancelik.loans.dto.ErrorResponseDto;
import com.cihancelik.loans.dto.LoansContactInfoDto;
import com.cihancelik.loans.dto.LoansDto;
import com.cihancelik.loans.dto.ResponseDto;
import com.cihancelik.loans.service.ILoansService;
...
@Tag(
        name = "CRUD REST APIs for Loans in MazeBank",
        description = "CRUD REST APIs in MazeBank to CREATE , UPDATE , FETCH AND DELETE Loan Details"
)
@RestController
...
public class LoansController {
    ...
    @Operation(
            ...
            description = "REST API to Crete new Loan inside MazeBank"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "201",
...
@ApiResponses({
    ...
    public ResponseEntity<ResponseDto> deleteLianDetails(@RequestParam
                                                         @Pattern(regexp = "ˆ$|[0-9]{10}", message = "Mobile Number Must Be 10 Digits")
                                                         String mobileNumber) {
    ...
    @Operation(
            ...
            description = "Java Version That Is Used In Loans Microservice"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
